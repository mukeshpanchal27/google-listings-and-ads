...
const RemoveProgramModal = ( props ) => {
	...
	return (
		...
		>
			<p>
				{ __(
					'Results typically improve with time with Google Ads campaigns. Removing a campaign will result in the loss of any optimisations learned from those campaigns.',
